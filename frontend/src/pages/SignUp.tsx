...
export const Signup = () => {
  return (
    <div className="relative grid min-h-screen place-items-center overflow-hidden bg-slate-950 p-6 text-white">
      ...
      <div className="relative w-full max-w-xl rounded-[2rem] border border-slate-700 bg-slate-900/90 p-8 shadow-[0_36px_95px_-35px_rgba(2,6,23,0.95)] backdrop-blur-md sm:p-10">
